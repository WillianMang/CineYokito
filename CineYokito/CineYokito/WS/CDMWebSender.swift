...
class CDMWebSender: NSObject {
    ...
    class func doPOSTCookieToURL(conURL url : NSString, conPath path : NSString, conParametros parametros : Any?, conCookie cookie : NSString, conCompletion completion : @escaping (_ objRespuesta : CDMWebResponse) -> Void) -> URLSessionDataTask {
    ...
    class func doGETCookieToURL(conURL url : NSString, conPath path : NSString, conParametros parametros : Any?, conCookie cookie : NSString, conCompletion completion : @escaping (_ objRespuesta : CDMWebResponse) -> Void) -> URLSessionDataTask {
    ...
    class func doPUTCookieToURL(conURL url : NSString, conPath path : NSString, conParametros parametros : Any?, conCookie cookie : NSString, conCompletion completion : @escaping (_ objRespuesta : CDMWebResponse) -> Void) -> URLSessionDataTask {
    ...
    class func doGETTokenToURL(conURL url : NSString, conPath path : NSString, conParametros parametros : Any?, conToken token : NSString, conCompletion completion : @escaping (_ objRespuesta : CDMWebResponse) -> Void) -> URLSessionDataTask {
